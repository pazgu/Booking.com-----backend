...
const index_1 = require("./index"); // Ensure correct path to your database connection
...
async function seedReviews() {
    try {
        ...
        `;
                await index_1.db
                    .promise()
                    .query(insertQuery, Object.values(review));
        ...
        `;
                await index_1.db
                    .promise()
                    .query(updateQuery, [hotel.id, hotel.id]);
